document.addEventListener("DOMContentLoaded", function() {
  ...
  function fetchResults() {
    ...
    fetch(`/docfica/recherche?${params.toString()}`)
      ...
      .then((data) => {
        ...
        data.dossiers.forEach((dossier) => {
          ...
          a.href = `/archivist/${dossier.id}/sous-fonds`;
          a.style.color = "black";
          div.appendChild(a);
        ...
        data.fichiers.forEach((fichier) => {
          ...
          a.href = `/archivist/${fichier.parentId}/sous-fonds`;
          a.style.color = "black";
          div.appendChild(a);
          resultContainer.appendChild(div);
        });
  ...
  depSelect.addEventListener("change", fetchResults);
